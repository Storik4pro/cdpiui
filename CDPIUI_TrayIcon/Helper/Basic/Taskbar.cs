...
namespace CDPIUI_TrayIcon.Helper.Basic
{
    ...
    public static class Taskbar
    {
        ...
        private static bool RefreshBoundsAndPosition()
        {
            ...
            return SHAppBarMessage(AppBarMessage.GetTaskbarPos, ref _appBarData) != nint.Zero;
        }
        ...
        private static extern nint SHAppBarMessage(AppBarMessage dwMessage, [In] ref APPBARDATA pData);
